...
export const SUBTASK_INDENT_PX = 44;
...
export function isNestIntent(clientX: number, startClientX: number) {
  return resolveHierarchyDragIntent(clientX, startClientX, null) === "nest";
}
